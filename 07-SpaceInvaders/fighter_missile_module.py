...
class Missile:
    ...
    def move(self):
        ...
        # Note: you could've instead passed in a speed when you made a Missile, but all missiles in the game are the same
...
class Fighter:
    def __init__(self, screen):
        ...
        self.y = self.screen.get_height() - self.image.get_height() - 3
        self.missiles = []
